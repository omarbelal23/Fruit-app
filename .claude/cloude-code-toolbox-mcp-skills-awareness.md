...
_Generated: 2026-04-29T21:57:39.609Z_
...
Workspace `mcp.json` _(folder: fruit_app)_

- **e:\Projects_flutter\fruit_app\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Omr\AppData\Roaming\Code\User\mcp.json** — _File missing_
